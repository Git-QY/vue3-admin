...
const dictSchemaRules = {
  ...
  dictType: { type: String, required: true }, // 类型 全局唯一
...
// 预校验
const dictValidationRules = isAdd => [
  ...
  body('dictType')
    ...
    .custom((value, { req }) => {
      ...
      if (!isAdd) query._id = { $ne: req.body._id }
      const dict = Dict.findOne(query)
...
module.exports = { Dict, DictItem, dictValidationRules, dictItemValidationRules, validationResult }
